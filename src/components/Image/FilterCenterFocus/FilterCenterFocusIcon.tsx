...
export interface IFilterCenterFocusIconProps {
  size?: number;
  rotate?: number;
  color?: Color;
}

export default function FilterCenterFocusIcon({
  size = 24,
  rotate = 0,
  color = "grey-100",
}: IFilterCenterFocusIconProps) {
