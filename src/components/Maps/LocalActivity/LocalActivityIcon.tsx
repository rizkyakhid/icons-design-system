...
export interface ILocalActivityIconProps {
  size?: number;
  rotate?: number;
  color?: Color;
}

export default function LocalActivityIcon({
  size = 24,
  rotate = 0,
  color = "grey-100",
}: ILocalActivityIconProps) {
